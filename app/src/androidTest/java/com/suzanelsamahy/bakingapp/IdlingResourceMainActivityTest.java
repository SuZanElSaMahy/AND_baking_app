...
public class IdlingResourceMainActivityTest {
    ...
    public void idlingResourceTest() {
        ...
        takeSecond();
        onView(allOf(withId(R.id.main_rv), isDisplayed())).perform(swipeUp());
        onView(allOf(withId(R.id.main_rv))).perform(RecyclerViewActions.actionOnItemAtPosition(0, click()));
    }
